...
def compute_ride_signal(
    ...
    **_ignored: object,
    ...
    if actionable:
        ...
        breakout_elite_pre = bool(stage == "PRE" and (impulse_type_hint in ("ORB", "VWAP")) and impulse_legitimacy >= 0.86 and accept_ok and breakout_extension_ok)
        breakout_confirmed_ok = bool(stage == "CONFIRMED" and (impulse_type_hint in ("ORB", "VWAP")) and impulse_legitimacy >= 0.72 and breakout_extension_ok)
